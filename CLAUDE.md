...
This project is indexed by GitNexus as **codex-config** (907 symbols, 2379 relationships, 76 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
