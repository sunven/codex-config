...
This project is indexed by GitNexus as **codex-config** (962 symbols, 2581 relationships, 81 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
