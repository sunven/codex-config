...
This project is indexed by GitNexus as **codex-config** (1411 symbols, 3723 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
