...
This project is indexed by GitNexus as **codex-config** (841 symbols, 2155 relationships, 70 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
