...
This project is indexed by GitNexus as **codex-config** (923 symbols, 2409 relationships, 77 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
